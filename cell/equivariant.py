...
class MultimerInvariantPointAttention(nn.Cell):
    ...
    def construct(self, inputs_1d, inputs_2d, mask, rotation, translation, sbr_act, sbr_mask, interface_mask):
        ...
        # Construct sbr_act_bias of shape:
        # [num_target_residues, num_target_residues, num_head]
        # sbr_act = self.sbr_layer(sbr_act)
        # sbr_act = ops.Transpose()(sbr_act, (2, 0, 1))
        # sbr_act *= sbr_mask[None, :, :]
        # sbr_act = ops.Transpose()(sbr_act, (1, 2, 0))
