...
if __name__ == "__main__":
    ...
    parser.add_argument('--jobname', default='simxlv2', type=str)
    ...
    restr_dir = f'{arguments.data_url}/xl_simulated_v2/out2_xls_restr'
    ...
    if arguments.ckpt_ids is not None:
        ...
        ckpt_ids = [i*1000 for i in [8, 14, 20, 22]] + [21946222, 22946222]
        # ckpt_ids = [21946222,]
    ckpt_ids.sort()
