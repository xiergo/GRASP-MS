...
if __name__ == "__main__":
    ...
    parser.add_argument('--ckpt_dir', default="jax_ckpt/converted_ms_ckpts", help='model config')
    ...
    parser.add_argument('--jobname', default='casp15_jax', type=str)
    ...
    res_dir = f'{arguments.train_url}/grasp_infer_res/{arguments.ckpt_dir.replace("/", "-")}_{arguments.jobname}'
    ...
    ckpt_ids = [i.replace('.ckpt', '') for i in os.listdir(ckpt_dir) if i.endswith('.ckpt')]
    ckpt_ids.sort()
    print(ckpt_ids)
